...
Namespace DAL.EntityClasses
	...
	''' <summary>Entity class which represents the entity 'TipoPagamento'.<br/><br/></summary>
	<Serializable()> _
...
#End Region
		...
		Public Sub New()
			MyBase.New("TipoPagamentoEntity")
		...
		''' <summary>CTor</summary>
		''' <param name="validator">The custom validator object for this TipoPagamentoEntity</param>
		...
		''' <summary>CTor</summary>
		''' <param name="codice">PK value for TipoPagamento which data should be fetched into this TipoPagamento object</param>
		...
		Protected Overrides Function GetRelationsForFieldOfType(fieldName As String ) As RelationCollection 
			Return TipoPagamentoEntity.GetRelationsForField(fieldName)
		End Function
...
#End If
		...
		Protected Overrides Overloads Function GetAllRelations() As List(Of IEntityRelation)
			Return New TipoPagamentoRelations().GetAllRelations()
		End Function

		''' <summary>Creates a New instance of the factory related To this entity</summary>
		Protected Overrides Function CreateEntityFactory() As IEntityFactory2 
			Return EntityFactoryCache2.GetEntityFactory(GetType(TipoPagamentoEntityFactory))
		End Function
#If Not CF Then
...
#End If
		...
		''' <param name="validator">The validator object for this TipoPagamentoEntity</param>
...
#Region "Class Property Declarations"
		...
		Public  Shared ReadOnly Property Relations() As TipoPagamentoRelations
			Get	
				Return New TipoPagamentoRelations() 
			End Get
		End Property
		...
		Protected Overrides ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
			Get
				Return TipoPagamentoEntity.CustomProperties
			End Get
		End Property
		...
		Protected Overrides ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
			Get
				Return TipoPagamentoEntity.FieldsCustomProperties
			End Get
		End Property

		''' <summary>The Codice property of the Entity TipoPagamento<br/><br/></summary>
		''' <remarks> Mapped on  table field: "TipoPagamento"."Codice"<br/>
		''' Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 10<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, False</remarks>
		Public Overridable Property [Codice]() As System.String
			Get
				Return CType(GetValue(CInt(TipoPagamentoFieldIndex.Codice), True), System.String)
			End Get
			Set
				SetValue(CInt(TipoPagamentoFieldIndex.Codice), value)
			End Set
		End Property
		''' <summary>The Descrizione property of the Entity TipoPagamento<br/><br/></summary>
		''' <remarks> Mapped on  table field: "TipoPagamento"."Descrizione"<br/>
		...
		Public Overridable Property [Descrizione]() As System.String
			Get
				Return CType(GetValue(CInt(TipoPagamentoFieldIndex.Descrizione), True), System.String)
			End Get
			Set
				SetValue(CInt(TipoPagamentoFieldIndex.Descrizione), value)
			End Set
		End Property
		...
		Protected Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
			Get 
				Return CInt(DAL.EntityType.TipoPagamentoEntity)
			End Get
		End Property
#End Region
