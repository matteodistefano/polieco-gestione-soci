...
Namespace DAL.EntityClasses
	...
	''' <summary>Entity class which represents the entity 'StatoPagamento'.<br/><br/></summary>
	<Serializable()> _
	Public Class StatoPagamentoEntity 
...
#End Region
		...
		Public Sub New()
			MyBase.New("StatoPagamentoEntity")
		...
		''' <summary>CTor</summary>
		''' <param name="validator">The custom validator object for this StatoPagamentoEntity</param>
		...
		''' <summary>CTor</summary>
		''' <param name="codice">PK value for StatoPagamento which data should be fetched into this StatoPagamento object</param>
		...
		Protected Overrides Function GetRelationsForFieldOfType(fieldName As String ) As RelationCollection 
			Return StatoPagamentoEntity.GetRelationsForField(fieldName)
		End Function
...
#End If
		...
		Protected Overrides Overloads Function GetAllRelations() As List(Of IEntityRelation)
			Return New StatoPagamentoRelations().GetAllRelations()
		End Function

		''' <summary>Creates a New instance of the factory related To this entity</summary>
		Protected Overrides Function CreateEntityFactory() As IEntityFactory2 
			Return EntityFactoryCache2.GetEntityFactory(GetType(StatoPagamentoEntityFactory))
		End Function
#If Not CF Then
...
#End If
		...
		''' <param name="validator">The validator object for this StatoPagamentoEntity</param>
...
#Region "Class Property Declarations"
		...
		Public  Shared ReadOnly Property Relations() As StatoPagamentoRelations
			Get	
				Return New StatoPagamentoRelations() 
			End Get
		End Property
		...
		Protected Overrides ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
			Get
				Return StatoPagamentoEntity.CustomProperties
			End Get
		End Property
		...
		Protected Overrides ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
			Get
				Return StatoPagamentoEntity.FieldsCustomProperties
			End Get
		End Property

		''' <summary>The Codice property of the Entity StatoPagamento<br/><br/></summary>
		''' <remarks> Mapped on  table field: "StatoPagamento"."Codice"<br/>
		''' Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 10<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, False</remarks>
		Public Overridable Property [Codice]() As System.String
			Get
				Return CType(GetValue(CInt(StatoPagamentoFieldIndex.Codice), True), System.String)
			End Get
			Set
				SetValue(CInt(StatoPagamentoFieldIndex.Codice), value)
			End Set
		End Property
		''' <summary>The Descrizione property of the Entity StatoPagamento<br/><br/></summary>
		''' <remarks> Mapped on  table field: "StatoPagamento"."Descrizione"<br/>
		...
		Public Overridable Property [Descrizione]() As System.String
			Get
				Return CType(GetValue(CInt(StatoPagamentoFieldIndex.Descrizione), True), System.String)
			End Get
			Set
				SetValue(CInt(StatoPagamentoFieldIndex.Descrizione), value)
			End Set
		End Property
		...
		Protected Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
			Get 
				Return CInt(DAL.EntityType.StatoPagamentoEntity)
			End Get
		End Property
#End Region
