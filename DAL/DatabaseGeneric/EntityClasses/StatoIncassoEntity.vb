...
Namespace DAL.EntityClasses
	...
	''' <summary>Entity class which represents the entity 'StatoIncasso'.<br/><br/></summary>
	<Serializable()> _
	Public Class StatoIncassoEntity 
...
#End Region
		...
		''' <summary>CTor</summary>
		''' <param name="validator">The custom validator object for this StatoIncassoEntity</param>
		...
		''' <summary>CTor</summary>
		''' <param name="codice">PK value for StatoIncasso which data should be fetched into this StatoIncasso object</param>
		...
		Protected Overrides Function GetRelationsForFieldOfType(fieldName As String ) As RelationCollection 
			Return StatoIncassoEntity.GetRelationsForField(fieldName)
		End Function
...
#End If
		...
		Protected Overrides Overloads Function GetAllRelations() As List(Of IEntityRelation)
			Return New StatoIncassoRelations().GetAllRelations()
		End Function

		''' <summary>Creates a New instance of the factory related To this entity</summary>
		Protected Overrides Function CreateEntityFactory() As IEntityFactory2 
			Return EntityFactoryCache2.GetEntityFactory(GetType(StatoIncassoEntityFactory))
		End Function
#If Not CF Then
...
#End If
		...
		''' <param name="validator">The validator object for this StatoIncassoEntity</param>
...
#Region "Class Property Declarations"
		...
		Public  Shared ReadOnly Property Relations() As StatoIncassoRelations
			Get	
				Return New StatoIncassoRelations() 
			End Get
		End Property
		...
		Protected Overrides ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
			Get
				Return StatoIncassoEntity.CustomProperties
			End Get
		End Property
		...
		Protected Overrides ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
			Get
				Return StatoIncassoEntity.FieldsCustomProperties
			End Get
		End Property

		''' <summary>The Codice property of the Entity StatoIncasso<br/><br/></summary>
		''' <remarks> Mapped on  table field: "StatoIncasso"."Codice"<br/>
		''' Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 10<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, False</remarks>
		Public Overridable Property [Codice]() As System.String
			Get
				Return CType(GetValue(CInt(StatoIncassoFieldIndex.Codice), True), System.String)
			End Get
			Set
				SetValue(CInt(StatoIncassoFieldIndex.Codice), value)
			End Set
		End Property
		''' <summary>The Descrizione property of the Entity StatoIncasso<br/><br/></summary>
		''' <remarks> Mapped on  table field: "StatoIncasso"."Descrizione"<br/>
		...
		Public Overridable Property [Descrizione]() As System.String
			Get
				Return CType(GetValue(CInt(StatoIncassoFieldIndex.Descrizione), True), System.String)
			End Get
			Set
				SetValue(CInt(StatoIncassoFieldIndex.Descrizione), value)
			End Set
		End Property
		...
		Protected Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
			Get 
				Return CInt(DAL.EntityType.StatoIncassoEntity)
			End Get
		End Property
#End Region
