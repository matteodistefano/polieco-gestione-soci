...
Namespace DAL.EntityClasses
	...
	''' <summary>Entity class which represents the entity 'TipoIncasso'.<br/><br/></summary>
	<Serializable()> _
	Public Class TipoIncassoEntity 
...
#End Region
		...
		''' <summary>CTor</summary>
		''' <param name="validator">The custom validator object for this TipoIncassoEntity</param>
		...
		''' <summary>CTor</summary>
		''' <param name="codice">PK value for TipoIncasso which data should be fetched into this TipoIncasso object</param>
		...
		Protected Overrides Function GetRelationsForFieldOfType(fieldName As String ) As RelationCollection 
			Return TipoIncassoEntity.GetRelationsForField(fieldName)
		End Function
...
#End If
		...
		Protected Overrides Overloads Function GetAllRelations() As List(Of IEntityRelation)
			Return New TipoIncassoRelations().GetAllRelations()
		End Function

		''' <summary>Creates a New instance of the factory related To this entity</summary>
		Protected Overrides Function CreateEntityFactory() As IEntityFactory2 
			Return EntityFactoryCache2.GetEntityFactory(GetType(TipoIncassoEntityFactory))
		End Function
#If Not CF Then
...
#End If
		...
		''' <param name="validator">The validator object for this TipoIncassoEntity</param>
...
#Region "Class Property Declarations"
		...
		Public  Shared ReadOnly Property Relations() As TipoIncassoRelations
			Get	
				Return New TipoIncassoRelations() 
			End Get
		End Property
		...
		Protected Overrides ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
			Get
				Return TipoIncassoEntity.CustomProperties
			End Get
		End Property
		...
		Protected Overrides ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
			Get
				Return TipoIncassoEntity.FieldsCustomProperties
			End Get
		End Property

		''' <summary>The Codice property of the Entity TipoIncasso<br/><br/></summary>
		''' <remarks> Mapped on  table field: "TipoIncasso"."Codice"<br/>
		''' Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 10<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, False</remarks>
		Public Overridable Property [Codice]() As System.String
			Get
				Return CType(GetValue(CInt(TipoIncassoFieldIndex.Codice), True), System.String)
			End Get
			Set
				SetValue(CInt(TipoIncassoFieldIndex.Codice), value)
			End Set
		End Property
		''' <summary>The Descrizione property of the Entity TipoIncasso<br/><br/></summary>
		''' <remarks> Mapped on  table field: "TipoIncasso"."Descrizione"<br/>
		...
		Public Overridable Property [Descrizione]() As System.String
			Get
				Return CType(GetValue(CInt(TipoIncassoFieldIndex.Descrizione), True), System.String)
			End Get
			Set
				SetValue(CInt(TipoIncassoFieldIndex.Descrizione), value)
			End Set
		End Property
		...
		Protected Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
			Get 
				Return CInt(DAL.EntityType.TipoIncassoEntity)
			End Get
		End Property
#End Region
