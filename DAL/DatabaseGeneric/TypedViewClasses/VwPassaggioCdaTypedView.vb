...
Namespace DAL.TypedViewClasses
	...
	''' <summary>Typed datatable for the view 'VwPassaggioCda'.<br/><br/></summary>
	<Serializable(), System.ComponentModel.DesignerCategory("Code"), ToolboxItem(True), DesignTimeVisible(True)> _
	Public Class VwPassaggioCdaTypedView 
		Inherits TypedViewBase(Of VwPassaggioCdaRow)
...
#End If		
		...
		Protected Overrides Function NewRowFromBuilder(rowBuilder As DataRowBuilder) As DataRow
			Return New VwPassaggioCdaRow(rowBuilder)
		End Function
		...
		Protected Overrides Overloads Sub InitClass()
			...
			_fields = ModelInfoProviderSingleton.GetInstance().GetTypedViewFields("VwPassaggioCdaTypedView")
		...
		Public Overrides Function Clone() As DataTable
			Dim cloneToReturn As VwPassaggioCdaTypedView = CType(MyBase.Clone(), VwPassaggioCdaTypedView)
...
#If Not CF Then
		...
		Protected Overrides Function CreateInstance() As DataTable
			Return New VwPassaggioCdaTypedView()
		End Function
#End If
...
#Region "Class Property Declarations"
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Hashtable
			Get
				Return VwPassaggioCdaTypedView.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Hashtable
			Get
				Return VwPassaggioCdaTypedView.FieldsCustomProperties
			End Get
		End Property
...
#End Region
	...
	''' <summary>Typed datarow for the typed datatable VwPassaggioCda</summary>
	Public Class VwPassaggioCdaRow 
		Inherits DataRow
		' __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesRow
		' __LLBLGENPRO_USER_CODE_REGION_END	

#Region "Class Member Declarations"
		Private _parent As VwPassaggioCdaTypedView
#End Region
		...
		Protected Friend Sub New(rowBuilder As DataRowBuilder)
			...
			_parent = CType(Me.Table, VwPassaggioCdaTypedView)
		End Sub

#Region "Class Property Declarations"

		''' <summary>Gets / sets the value of the TypedView field Id<br/><br/></summary>
		''' <remarks>Mapped on view field: "vwPassaggioCDA"."Id"<br/>
		...
		''' <remarks>Mapped on view field: "vwPassaggioCDA"."RagioneSociale"<br/>
		...
		''' <remarks>Mapped on view field: "vwPassaggioCDA"."Localita"<br/>
		...
		''' <remarks>Mapped on view field: "vwPassaggioCDA"."provincia"<br/>
		...
		''' <remarks>Mapped on view field: "vwPassaggioCDA"."CodCategoria"<br/>
		...
		''' <remarks>Mapped on view field: "vwPassaggioCDA"."CodiceFiscale"<br/>
		...
		''' <remarks>Mapped on view field: "vwPassaggioCDA"."PartitaIVA"<br/>
		''' View field characteristics (type, precision, scale, length): VarChar, 0, 0, 16</remarks>
		...
		''' <remarks>Mapped on view field: "vwPassaggioCDA"."Motivo"<br/>
