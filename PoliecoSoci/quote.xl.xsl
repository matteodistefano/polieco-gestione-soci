 ...
 <!--<tr>
  ...
  <xsl:if test="$category='B'">
    <xsl:for-each select="/report/analisi[@CatQuota=$category]">
             ...
             <tr height="17">
               ...
               <!--F category quote--> 
               <td class="percBlack" x:fmla="$F${$endsum+7}/$D${$endsum+1}"></td>
               
                <!--G Polieco quote--> 
               <td class="percBlack" x:fmla="$G${$endsum+7}/$D${$endsum+1}"></td>
               ...
               <td class="percGreen" x:fmla="IF(E{$count -1 + $startsum}=1,$J${$endsum+7}/$E{$endsum+1},0)"></td>
  ...
  <xsl:if test="$category='B(a)'">
      <tr>
          ...
          <td class="percBlack" x:fmla="0.2/$D${$endsum+1}"></td>  
