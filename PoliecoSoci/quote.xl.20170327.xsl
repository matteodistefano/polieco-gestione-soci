...
<body>
  <table border="0" cellpadding="0" cellspacing="0">   
    ...
    <xsl:variable name="categoryBArow">
      <xsl:value-of select="count(//report/analisi[@CatQuota='B(a)']) + 1"/>
    </xsl:variable>
    ...
    <xsl:for-each select="/report/parametro[@nome='Categoria']">
       ...
       <tr height="51">
        ...
        <xsl:call-template name="contentcategory">
            ...
            <xsl:with-param name="categoryBArow" select="$categoryBArow"/>
...
<xsl:template name="contentcategory" xmlns:ss="urn:schemas-microsoft-com:office:spreadsheet" xmlns="urn:schemas-microsoft-com:office:spreadsheet">
  ...
  <xsl:variable name="catBAspan">
    <xsl:value-of select="$headercatgoryrow + $bottomcatgoryrow +  $categoryBArow"/>
  </xsl:variable>
  ...
  <xsl:variable name="startsum">
    ...
    <xsl:if test="$category = 'B(a)'"><xsl:value-of select="($headerrow + $headercatgoryrow + 1 + $catAspan+$catBspan)"/></xsl:if>
    <xsl:if test="$category = 'C'"><xsl:value-of select="($headerrow + $headercatgoryrow + 1 + $catAspan + $catBspan+$catBAspan)"/></xsl:if>
    <xsl:if test="$category = 'D'"><xsl:value-of select="($headerrow + $headercatgoryrow + 1 + $catAspan + $catBspan +$catBAspan + $catCspan)"/></xsl:if>
    <xsl:if test="$category = 'E'"><xsl:value-of select="($headerrow + $headercatgoryrow + 1 + $catAspan + $catBspan +$catBAspan + $catCspan + $catDspan)"/></xsl:if>
  </xsl:variable>
  ...
  <xsl:variable name="endsum">
    ...
    <xsl:if test="$category = 'B(a)'"><xsl:value-of select="($headerrow + $headercatgoryrow + $catAspan + $catBspan + $categoryBArow)"/></xsl:if>
    <xsl:if test="$category = 'C'"><xsl:value-of select="($headerrow + $headercatgoryrow + $catAspan + $catBspan + $catBAspan + $categoryCrow)"/></xsl:if>
    <xsl:if test="$category = 'D'"><xsl:value-of select="($headerrow + $headercatgoryrow + $catAspan + $catBspan + $catBAspan+ $catCspan + $categoryDrow)"/></xsl:if>
    <xsl:if test="$category = 'E'"><xsl:value-of select="($headerrow + $headercatgoryrow + $catAspan + $catBspan + $catBAspan+ $catCspan + $catDspan + $categoryErow)"/></xsl:if>
  </xsl:variable>
...
<!--  DEBUG SECTION -->
 <!--<tr>
  ...
  <xsl:if test="contains('A|C|D|E|',concat($category,'|'))">
      <xsl:for-each select="/report/analisi[@CatQuota=$category]">
        ...
        <tr>
           ...
           <xsl:if test="$category = 'B' or $category = 'B(a)'">
             <td class="totalNumber" align="right" x:fmla="counta(B{$startsum}:B{$endsum})"></td>
           </xsl:if>
           <xsl:if test="not($category = 'B' or $category = 'B(a)')">
             <td class="totalNumber" align="right" x:fmla="sum(D{$startsum}:D{$endsum})"></td>
           </xsl:if>
     
           <td class="totalNumber" align="right" x:fmla="sum(E{$startsum}:E{$endsum})"></td>
  ...
  <xsl:if test="$category='B'">
    <xsl:for-each select="/report/analisi[@CatQuota=$category]">
             <!--  CALCULATE POSITION ON EXCEL -->
             <xsl:variable name="count" select="count(preceding-sibling::analisi[@CatQuota = 'B'])+1"></xsl:variable>
             
             <tr height="17">
               <!--  category --> 
               <td class="contentNormal" align="right">B</td>
               ...
               <!--F category quote--> 
               <td class="percBlack" x:fmla="if(E{$count + $startsum - 1}=1,($F${$endsum+7}/$E${$endsum+1}),0)"></td>
               
                <!--G Polieco quote--> 
               <td class="percBlack" x:fmla="if(E{$count + $startsum - 1}=1,($G${$endsum+7}/$E${$endsum+1}),0)"></td>
 
                <!--H company payment and declaration status OK quote--> 
               <td class="percBlu" x:fmla="IF(E{$count -1 + $startsum}=1,G{$count -1 + $startsum},0)"></td>
  
                <!--I company payment and declaration status NO quote--> 
               <td class="percRed" x:fmla="IF(E{$count -1 + $startsum}=0,G{$count -1 + $startsum},0)"></td>

                <!--J Quote on company == OK for category--> 
               <td class="percGreen" x:fmla="IF(E{$count -1 + $startsum}=1,H{$count -1 + $startsum},0)"></td>
  ...
  <xsl:if test="$category='B(a)'">
      <tr>
          <td class="contentNormal">
            B
          </td>
          <td class="contentNormal">
            <strong>Associazione utilizzatori singoli aderenti</strong>
          </td>
          <td class="contentNormal"></td>
          <td class="contentNormal"></td>
          <td class="numcontentNoborder9">1</td>
          <td class="percBlack" x:fmla="G{$startsum}*5"></td>
          <td class="percBlack" x:fmla="if(E{$startsum}=1,0.2/$E${$endsum+1},0)"></td>
          <td class="percBlu" x:fmla="IF(E{$startsum}=1,G{$startsum},0)"></td>
          <td class="percRed" x:fmla="IF(E{$startsum}=0,G{$startsum},0)"></td>
          <td class="percGreen" x:fmla="IF(E{$startsum}=1,H{$startsum} * 0.2 / $H${$endsum + 1} ,0)"></td>
          <td class="contentNormalNoBorder" align="left">
            <xsl:value-of select="./@RagioneSociale"/>
          </td>
          <td class="contentNormalNoBorder" align="right"></td>
          <td class="noBorderBluPerc"></td>
          <td class="noBorderGreenPerc"></td>
          <td class="contentNormalNoBorder" align="left">
            <xsl:value-of select="./@RagioneSociale"/>
          </td>
          <td class="contentNormalNoBorder"></td>
          <td class="noBorderBluPerc"></td>
          <td class="noBorderGreenPerc"></td>
       </tr>
        ...
        <xsl:for-each select="/report/analisi[@CatQuota=$category]">
             <!--  CALCULATE POSITION ON EXCEL -->
             <xsl:variable name="count" select="count(preceding-sibling::analisi[@CatQuota = 'B(a)'])+2"></xsl:variable>
             ...
             <tr height="17">
               ...
               <!-- Polieco quote -->
               <td class="percBlack" x:fmla="if(E{$count - 1 + $startsum}=1,0.2/$E${$endsum+1},0)"></td>
  ...
  <xsl:if test="false"> 
      ...
      <xsl:for-each select="/report/analisi[@CatQuota=$category]">
         ...
         <xsl:variable name="count">
           ...
           <xsl:if test="$category = 'B(a)'">
             <xsl:value-of select="count(preceding-sibling::analisi[@CatQuota = 'B(a)'])+2"/>
           </xsl:if>
