...
Public Class Manager
    ...
    Public Shared Sub Open(Path As String)
        Try
            Dim ds As New Datasets.dsDichiarazione2019
            ds.ReadXml(Path)
    ...
    Public Shared Function GetCoefficienti(d As Datasets.dsDichiarazione2019) As System.Collections.Generic.Dictionary(Of String, Single)
    ...
    Public Shared Function ImportaDichiarazione(ds As Datasets.dsDichiarazione2019) As DichiarazioneOnLineEntity
        'Verifica se esiste
    ...
    Public Shared Function GetTotaleDichiarazione(ds As Datasets.dsDichiarazione2019) As Decimal


        Dim d As Datasets.dsDichiarazione2019.DichiarazioneRow = ds.Dichiarazione(0)
    ...
    Public Shared Function AssociaDichiarazione(dol As DichiarazioneOnLineEntity, AutoCheck As Boolean) As DichiarazioneEntity
        ...
        Try
            ...
            Dim ds As Datasets.dsDichiarazione2019 = dol.DatiCompilati
            Dim dc As Datasets.dsDichiarazione2019.DichiarazioneRow = ds.Dichiarazione(0)
            ...
            Else
                ...
                If dc.CatE Then
                    If dc.VE1 <> 0 Then dic.AddDettaglio("E1", 1, Iva, dc.VE1)
                End If
            End If
            ...
            If ds.Prodotto IsNot Nothing AndAlso ds.Prodotto.Count > 0 Then
