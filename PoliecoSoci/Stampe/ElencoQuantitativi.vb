...
Public Class ElencoQuantitativi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PoliecoSoci.ElencoQuantitativi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedElencoQuantitativi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ElencoQuantitativi = New ElencoQuantitativi()
        rpt.Site = Me.Site
        Return rpt
    End Function
