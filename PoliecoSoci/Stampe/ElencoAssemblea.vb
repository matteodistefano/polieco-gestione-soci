...
Public Class ElencoAssemblea
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PoliecoSoci.ElencoAssemblea.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedElencoAssemblea
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ElencoAssemblea = New ElencoAssemblea()
        rpt.Site = Me.Site
        Return rpt
    End Function
