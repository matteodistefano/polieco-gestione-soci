...
Public Class FDichiarazione
    ...
    Public Sub Apri(ds As Datasets.dsDichiarazione)
        data = ds
        Inizializza()
        Me.ShowDialog()
    End Sub
...
#End Region
    ...
    Private Sub AggiornaConteggio()
        ...
        Dim d As Datasets.dsDichiarazione.DichiarazioneRow = data.Dichiarazione(0)
...
#Region "Gestione azienda"
    ...
    Private Sub AggiornaLayoutAzienda()
        ...
        Dim dic As DAL.Datasets.dsDichiarazione.DichiarazioneRow = data.Dichiarazione(0)
