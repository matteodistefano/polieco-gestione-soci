...
Public Class FAzienda
    ...
    Private Sub FetchAzienda()
        ...
        PP.Add(AziendaEntity.PrefetchPathDichiarazioni, 0, Nothing, Nothing, New SortExpression(DichiarazioneFields.DataScadenzaDichiarazione Or SortOperator.Descending)).SubPath.Add(DichiarazioneEntity.PrefetchPathAllegato)
    ...
    Private Sub UpdateLayout()
        ...
        tsbAttivaSocio.Available = (_Azienda.CodStato = Enums.StatoSocio.NUOVO)
...
#Region "Eventi"
    ...
    Private Sub dgvEventi_CellFormatting(sender As Object, e As DataGridViewCellFormattingEventArgs) Handles dgvEventi.CellFormatting
        ...
        If col Is dgvcEvStato Then
            ...
            End If
        ElseIf col Is dgvcEvNotifica Then
            If rw.IsChiuso Then
