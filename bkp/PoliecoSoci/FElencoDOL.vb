...
Public Class FElencoDOL
    ...
    Private Sub Inizializza()
        ...
        DichiarazioneOnLine.Manager.PrenotaDocumentoArxivar = _
    ...
    Private Sub CaricaDati()
        ...
        If txt <> "" Then
            ...
            Dim Fld As New EntityField("RagioneSociale", New mdsLLBLGenUtility.Expressions.XPathExpression(DichiarazioneOnLineFields.Dati, fpi, "(/dsDichiarazione/Dichiarazione/RagioneSociale)[1]", "varchar(200)"))
        ...
        If txt <> "" Then
            Dim fpi As FieldPersistenceInfo = DA.GetDAFieldPersistenceInfo(DichiarazioneOnLineFields.Dati)
            Dim Fld As New EntityField("SedeLegale", New mdsLLBLGenUtility.Expressions.XPathExpression(DichiarazioneOnLineFields.Dati, fpi, "(/dsDichiarazione/Dichiarazione/SedeLegale)[1]", "varchar(200)"))
            pr.AddWithAnd(Fld Mod ("%" & txt & "%"))
        End If
        ...
        If txt <> "" Then
            Dim fpi As FieldPersistenceInfo = DA.GetDAFieldPersistenceInfo(DichiarazioneOnLineFields.Dati)
            Dim Fld As New EntityField("PartitaIVA", New mdsLLBLGenUtility.Expressions.XPathExpression(DichiarazioneOnLineFields.Dati, fpi, "(/dsDichiarazione/Dichiarazione/PartitaIVA)[1]", "varchar(200)"))
            pr.AddWithAnd(Fld Mod ("%" & txt & "%"))
        End If

        If mcStato.HasUnChecked Then
        ...
        Me.Text = "Elenco dichiarazoni compilate on-line [ " & _DOL.Count & " documenti ]"
    ...
    Private Sub tsbAnalizza_Click(sender As Object, e As EventArgs) Handles tsbAnalizza.Click
        Try
            ...
            LogView.LogTitle = "Analisi e associaciazione dichiarazioni"
            LogView.ClearLog()
            LogView.ShowLog()
