    ...
    Private Sub tsbDuplica_Click(sender As Object, e As EventArgs) Handles tsbDuplica.Click
        Try
            ...
            For Each s In ss
                ...
                ns.DataFine = Microsoft.VisualBasic.DateSerial(Anno, s.DataFine.Month, s.DataInizio.Month)
                ns.DataInizio = Microsoft.VisualBasic.DateSerial(Anno, s.DataInizio.Month, s.DataInizio.Month)
                ns.DataScadenzaDichiarazione = Microsoft.VisualBasic.DateSerial(Anno, s.DataScadenzaDichiarazione.Month, s.DataScadenzaDichiarazione.Month)
                ns.DataScadenzaPagamento = Microsoft.VisualBasic.DateSerial(Anno, s.DataScadenzaPagamento.Month, s.DataScadenzaPagamento.Month)
