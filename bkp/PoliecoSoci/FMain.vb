    ...
    Private Sub CheckEventiNotifiche()
        Try
            ...
            Dim Sql As String = "Select ea.DataAvviso,az.id,az.RagioneSociale,ea.causale 
                        ...
                        and ea.codUtente='" & UtentiManager.UtenteCorrente.UserName & "'     
...
#End Region
    ...
    Private Sub DichiarazioniOnlineToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DichiarazioniOnlineToolStripMenuItem.Click
        Try
